    ...
    <>
      <footer className="bg-foreground text-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
            <div>
              <h3 className="font-bold text-lg mb-4">BOOSTCAMP</h3>
              <p className="opacity-70 text-sm leading-relaxed">
                전 세계 브랜드를 위한 탁월한 디지털 경험을 만들고 있습니다.
              </p>
            </div>
            ...
            <div>
              ...
              <div className="flex gap-4">
                <Link href="#" className="text-background hover:opacity-70 transition">
                  <Mail size={20} />
                </Link>
                <Link href="#" className="text-background hover:opacity-70 transition">
                  <Linkedin size={20} />
      ...
      <Dialog open={isPrivacyOpen} onOpenChange={setIsPrivacyOpen}>
        <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle className="text-3xl font-bold">개인정보 처리방침</DialogTitle>
          </DialogHeader>
          <div className="mt-4 space-y-8 text-foreground">
            ...
            <section className="space-y-4">
              <p className="leading-relaxed">
                부스트캠프 경기지사 (이하 &quot;회사&quot;는) 고객님의 개인정보를 중요시하며, &quot;정보통신망 이용촉진 및 정보보호&quot;에 관한 법률을 준수하고 있습니다.
              </p>
              <p className="leading-relaxed">
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-semibold mt-8 mb-4">수집하는 개인정보 항목 및 수집방법</h2>
              
              <div className="space-y-3">
                <h3 className="text-xl font-medium mt-6 mb-3">가. 수집하는 개인정보의 항목</h3>
                <p className="leading-relaxed">
                  회사는 회원가입, 상담, 서비스 신청 등을 위해 아래와 같은 개인정보를 수집하고 있습니다.
                </p>
                <ul className="space-y-2 ml-6 list-disc leading-relaxed">
                  <li>
                    <strong>회원가입시</strong> : 이름, 생년월일, 성별, 로그인ID, 비밀번호, 자택 전화번호, 휴대전화번호, 이메일, 14세미만 가입자의 경우 법정대리인의 정보
                  </li>
                  <li>
                    <strong>서비스 신청시</strong> : 주소, 결제 정보
                  </li>
                </ul>
              ...
              <div className="space-y-3">
                <h3 className="text-xl font-medium mt-6 mb-3">나. 수집방법</h3>
                <p className="leading-relaxed">
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-semibold mt-8 mb-4">개인정보의 수집 및 이용목적</h2>
              <p className="leading-relaxed mb-4">
                회사는 수집한 개인정보를 다음의 목적을 위해 활용합니다.
              </p>
              <ul className="space-y-3 ml-6 list-disc leading-relaxed">
                <li>
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-semibold mt-8 mb-4">개인정보의 보유 및 이용기간</h2>
              <p className="leading-relaxed mb-4">
                원칙적으로, 개인정보 수집 및 이용목적이 달성된 후에는 해당 정보를 지체 없이 파기합니다. 단, 다음의 정보에 대해서는 아래의 이유로 명시한 기간 동안 보존합니다.
              </p>
              
              <div className="space-y-3">
                <h3 className="text-xl font-medium mt-6 mb-3">가. 회사 내부방침에 의한 정보보유 사유</h3>
                <p className="leading-relaxed">
              ...
              <div className="space-y-3">
                <h3 className="text-xl font-medium mt-6 mb-3">나. 관련 법령에 의한 정보 보유 사유</h3>
                <p className="leading-relaxed mb-4">
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-semibold mt-8 mb-4">개인정보의 파기절차 및 방법</h2>
              <p className="leading-relaxed mb-4">
                회사는 원칙적으로 개인정보 수집 및 이용목적이 달성된 후에는 해당 정보를 지체없이 파기합니다. 파기절차 및 방법은 다음과 같습니다.
              </p>
              
              <div className="space-y-3">
                <h3 className="text-xl font-medium mt-6 mb-3">파기절차</h3>
                <p className="leading-relaxed">
              ...
              <div className="space-y-3">
                <h3 className="text-xl font-medium mt-6 mb-3">파기방법</h3>
                <p className="leading-relaxed">
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-semibold mt-8 mb-4">개인정보 제공</h2>
              <p className="leading-relaxed mb-4">
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-semibold mt-8 mb-4">수집한 개인정보의 위탁</h2>
              <p className="leading-relaxed mb-4">
                회사는 서비스 이행을 위해 아래와 같이 외부 전문업체에 위탁하여 운영하고 있습니다.
              </p>
              <ul className="space-y-2 ml-6 list-disc leading-relaxed">
                <li><strong>위탁 대상자</strong>: KCP</li>
                <li><strong>위탁업무 내용</strong>: 카드결제/ 계좌이체/ 휴대폰결제</li>
              </ul>
            </section>

            <section className="space-y-4">
              <h2 className="text-2xl font-semibold mt-8 mb-4">이용자 및 법정대리인의 권리와 그 행사방법</h2>
              <ul className="space-y-3 ml-6 list-disc leading-relaxed">
                <li>
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-semibold mt-8 mb-4">개인정보 자동수집 장치의 설치, 운영 및 그 거부에 관한 사항</h2>
              <p className="leading-relaxed mb-4">
              ...
              <div className="space-y-3">
                <h3 className="text-xl font-medium mt-6 mb-3">쿠키 등 사용 목적</h3>
                <ol className="space-y-2 ml-6 list-decimal leading-relaxed">
                  <li>
              ...
              <div className="space-y-3">
                <h3 className="text-xl font-medium mt-6 mb-3">쿠키 설정 거부 방법</h3>
                <ol className="space-y-2 ml-6 list-decimal leading-relaxed">
                  <li>
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-semibold mt-8 mb-4">개인정보에 관한 민원서비스</h2>
              <p className="leading-relaxed mb-4">
              ...
              <div className="space-y-4">
                <div>
                  <h3 className="text-xl font-medium mt-6 mb-3">개인정보보호담당자</h3>
                  <ul className="space-y-1 ml-6 list-disc leading-relaxed">
                    <li>성명: </li>
                    <li>소속: </li>
                    <li>전화번호: </li>
                    <li>이메일: </li>
                ...
                <div>
                  <h3 className="text-xl font-medium mt-6 mb-3">개인정보보호책임자</h3>
                  <ul className="space-y-1 ml-6 list-disc leading-relaxed">
                    <li>성명: </li>
                    <li>소속: </li>
                    <li>전화번호: </li>
              ...
              <ul className="space-y-3 mt-6 ml-6 list-disc leading-relaxed">
                <li>
      ...
      <Dialog open={isTermsOpen} onOpenChange={setIsTermsOpen}>
        <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle className="text-3xl font-bold">이용약관</DialogTitle>
          </DialogHeader>
          <div className="mt-4 space-y-8 text-foreground">
            <div className="text-muted-foreground">
              <p>최종 수정일: 2025년 1월 1일</p>
            ...
            <section className="space-y-4">
              ...
              <ol className="space-y-3 list-decimal list-inside leading-relaxed">
                <li>
                  &quot;몰&quot;이란 부스트캠프 경기지사 회사가 재화 또는 용역(이하 &quot;재화 등&quot;이라 함)을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화 등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.
                </li>
                <li>
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-semibold mt-8 mb-4">제3조 (약관 등의 명시와 설명 및 개정)</h2>
              <ol className="space-y-3 list-decimal list-inside leading-relaxed">
                <li>
                  &quot;몰&quot;은 이 약관의 내용과 상호 및 대표자 성명, 영업소 소재지 주소(소비자의 불만을 처리할 수 있는 곳의 주소를 포함), 전화번호, 모사전송번호, 전자우편주소, 사업자등록번호, 통신판매업 신고번호, 개인정보보호책임자등을 이용자가 쉽게 알 수 있도록 부스트캠프 경기지사 사이버몰의 초기 서비스화면(전면)에 게시합니다. 다만, 약관의 내용은 이용자가 연결화면을 통하여 볼 수 있도록 할 수 있습니다.
                </li>
                <li>
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-semibold mt-8 mb-4">제7조(회원 탈퇴 및 자격 상실 등)</h2>
              <ol className="space-y-3 list-decimal list-inside leading-relaxed">
                <li>
